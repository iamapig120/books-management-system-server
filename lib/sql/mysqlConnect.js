          ...
          obj[tableName] = {
            ...
            select: ({
              ...
              return new Promise((resolve, reject) => {
                ...
                // ColorLog.log(
                //   `数据表 ${tableName} 中执行了一条 Select 语句`,
                //   'MySQL'
                // )
              })
            },
            ...
            insert: (params = throwIfMissing()) => {
              ...
              return new Promise((resolve, reject) => {
                ...
                ColorLog.log(
                  `数据表 ${tableName} 中执行了一条 Insert 语句`,
                  'MySQL'
                )
              })
            },
            ...
            update: (params1 = throwIfMissing(), params2 = {}) => {
              ...
              return new Promise((resolve, reject) => {
                ...
                ColorLog.log(
                  `数据表 ${tableName} 中执行了一条 Update 语句`,
                  'MySQL'
                )
              })
            },
            ...
            delete: (params = {}) => {
              ...
              const confirmFun = () =>
                new Promise((resolve, reject) => {
                  ...
                  ColorLog.warn(
                    `数据表 ${tableName} 中执行了一条 Delete 语句！`,
                    'MySQL'
                  )
                })
              if (paramsLength > 0) {
                ColorLog.warn(
                  `数据表 ${tableName} 中正在尝试执行Delete语句！`,
                  'MySQL'
                )
                return confirmFun()
              } else {
            ...
            count: (column, where) => {
              ...
              return new Promise((resolve, reject) => {
                ...
                ColorLog.warn(
                  `数据表 ${tableName} 中执行了一条 Select 语句，并使用了 Count 命令`,
                  'MySQL'
                )
              })
            },
